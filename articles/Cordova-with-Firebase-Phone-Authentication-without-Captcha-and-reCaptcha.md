...
<img name="pinch" alt="Firebase console screen for registering a new Android app with name, package name, and debug signing certificate SHA-1 fields" src="/img/registerapp.png" width="1348" height="477"/>
...
<img name="pinch" alt="Firebase console screen after registering the app, showing the Download google-services.json button" src="/img/downloadserivcejson.webp" width="1348" height="357"/>
...
<img name="pinch" alt="Firebase console Authentication > Sign-in method screen with the Phone provider enabled" src="/img/develop_authentication_signinmethods_phone_enabled.webp" width="1345" height="462"/>
